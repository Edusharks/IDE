...
// A curated list of common, kid-friendly objects from the ImageNet model.
// The second value (e.g., 'cat') must match the categoryName from the model.
...
Blockly.defineBlocksWithJsonArray([
...
},
    {
        ...
        "message0": "is image classified as %1 ?", // Clearer
        "args0": [{
            "type": "field_dropdown",
            "name": "CLASS",
            "options": CLASSIFICATION_CLASSES
        }],
        "output": "Boolean",
        "style": IMAGE_CLASSIFICATION_BLOCK_STYLE,
    ...
    },
    {
        ...
        "message0": "get image classification", // Clearer
        "output": "String",
        "style": IMAGE_CLASSIFICATION_BLOCK_STYLE,
