...
(() => {
    ...
    const blockDefinitions = [
        ...
        { "type": "actuator_neopixel_setup", "message0": "setup NeoPixel strip on pin %1 with %2 pixels", "args0": [ { "type": "field_dropdown", "name": "PIN", "options": PICO_DIGITAL_PINS }, { "type": "input_value", "name": "NUM_PIXELS", "check": "Number" } ], "inputsInline": true, "previousStatement": null, "nextStatement": null, "style": "actuator_blocks" },
        { "type": "actuator_neopixel_brightness", "message0": "set NeoPixel brightness to %1 %%", "args0": [{ "type": "input_value", "name": "BRIGHTNESS", "check": "Number" }], "inputsInline": true, "previousStatement": null, "nextStatement": null, "style": "actuator_blocks", "tooltip": "Sets the overall brightness (0-100). Must be used after setup." },
        ...
        // --- OLED Display Blocks ---
        {
            ...
            "message0": "setup OLED display on I2C pins %1",
            "args0": [{ "type": "field_dropdown", "name": "PINS", "options": PICO_I2C_PINS }],
            "previousStatement": null,
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Initializes the 128x64 OLED display. Must be in the 'on start' block."
        },
        {
            ...
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Updates the physical screen with any drawings made since the last 'show'."
        },
        {
            ...
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Erases the entire screen content. Does not show automatically."
        },
        {
            "type": "display_oled_power",
            "message0": "turn OLED display %1",
            "args0": [{ "type": "field_dropdown", "name": "STATE", "options": [["ON", "poweron"], ["OFF", "poweroff"]] }],
            "previousStatement": null,
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Turns the display panel on or off to save power."
        },
        {
            "type": "display_oled_contrast",
            "message0": "set OLED contrast to %1",
            "args0": [{ "type": "input_value", "name": "CONTRAST", "check": "Number" }],
            "inputsInline": true,
            "previousStatement": null,
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Sets the display contrast (0-255)."
        },
        {
            "type": "display_oled_invert",
            "message0": "invert OLED colors %1",
            "args0": [{ "type": "field_dropdown", "name": "INVERT", "options": [["ON", "1"], ["OFF", "0"]] }],
            "inputsInline": true,
            "previousStatement": null,
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Inverts the display colors (black becomes white)."
        },
        {
            ...
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Draws text on the display buffer."
        },
        {
            ...
            "args0": [
                { "type": "input_value", "name": "X", "check": "Number" },
                { "type": "input_value", "name": "Y", "check": "Number" },
                { "type": "field_dropdown", "name": "COLOR", "options": [["ON", "1"], ["OFF", "0"]] }
            ],
            "inputsInline": true,
            "previousStatement": null,
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Draws a single pixel on the display buffer."
        },
        {
            ...
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Draws a line between two points."
        },
        {
            "type": "display_oled_rect",
            "message0": "%1 rectangle at x %2 y %3 width %4 height %5",
            "args0": [
                { "type": "field_dropdown", "name": "MODE", "options": [["draw", "rect"], ["fill", "fill_rect"]] },
                { "type": "input_value", "name": "X", "check": "Number" },
                { "type": "input_value", "name": "Y", "check": "Number" },
            ...
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Draws or fills a rectangle."
        },
        {
            ...
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Runs a pre-made fireworks animation. This block will pause the code."
        },
        {
            "type": "display_oled_create_image",
            "message0": "create image width %1 height %2",
            "message1": "from bytearray data %1",
            "args0": [
                { "type": "input_value", "name": "WIDTH", "check": "Number" },
                { "type": "input_value", "name": "HEIGHT", "check": "Number" }
            ],
            ...
            "output": "Image",
            "style": "display_blocks",
            "tooltip": "Creates an image from a bytearray. Use an external tool to convert an image file to a bytearray string.",
            "inputsInline": true
        },
        {
            ...
            "nextStatement": null,
            "style": "display_blocks",
            "tooltip": "Draws a previously created image onto the display buffer."
        },
        ...
        // --- Wi-Fi Blocks (Pico W) ---
        {
            ...
            "tooltip": "Connects the Pico W to a Wi-Fi network. Place in 'on start'."
        },
        {
        ...
        },
        {
            ...
            "output": "Dictionary",
            "style": "networking_blocks",
            "tooltip": "Fetches data from a web API and prepares it for use."
        },
        {
            "type": "json_get_key",
            "message0": "from JSON data %1 get value of key %2",
            "args0": [
                { "type": "input_value", "name": "JSON", "check": "Dictionary" },
                { "type": "input_value", "name": "KEY", "check": "String" }
            ],
            "output": null, // Can be string, number, etc.
            "style": "networking_blocks",
            "tooltip": "Extracts a specific value from JSON data."
        },
        {
            "type": "http_post_json",
            ...
            "message3": "value3 %1",
            "args0": [{ "type": "input_value", "name": "URL", "check": "String" }],
            "args1": [{ "type": "input_value", "name": "VALUE1" }],
            "args2": [{ "type": "input_value", "name": "VALUE2" }],
            "args3": [{ "type": "input_value", "name": "VALUE3" }],
            "previousStatement": null,
            "nextStatement": null,
            "style": "networking_blocks",
            "tooltip": "Sends up to three values to a service like IFTTT."
        },
        {
            ...
            "nextStatement": null,
            "style": "networking_blocks",
            "tooltip": "Initializes a web server on the Pico. Place in 'on start'."
        },
        {
            ...
            "style": "networking_blocks",
            "tooltip": "Runs code when the Pico's IP address is visited in a browser."
        },
        {
            ...
            "nextStatement": null,
            "style": "networking_blocks",
            "tooltip": "Sends a webpage back to the connected browser."
        },
        {
            ...
            "output": "String",
            "style": "networking_blocks",
            "tooltip": "Gets the path of the URL requested by the browser (e.g., '/led/on')."
        },
