  ...
  "node_modules/blockly/python_compressed.js"(exports, module) {
    (function(root, factory) {
      ...
      var lists_create_empty$$module$build$src$generators$python$lists = function(a, b) {
        ...
        return [
          "len(" + (b.valueToCode(a, "VALUE", Order$$module$build$src$generators$python$python_generator.NONE) || "[]") + ")",
...
`) + "(" + c + ', "' + d + '", ' + a + ")", Order$$module$build$src$generators$python$python_generator.FUNCTION_CALL];
        ...
        if (a.getInput("ELSE") || b.STATEMENT_SUFFIX) e = a.getInput("ELSE") ? b.statementToCode(
          a,
          "ELSE"
        ) || b.PASS : b.PASS, b.STATEMENT_SUFFIX && (e = b.prefixLines(b.injectId(b.STATEMENT_SUFFIX, a), b.INDENT) + e), d += "else:\n" + e;
        return d;
...
`);
        ...
        a = c === "SIN" || c === "COS" || c === "TAN" ? b.valueToCode(
          a,
          "NUM",
...
//# sourceMappingURL=chunk-EKICIPQK.js.map
