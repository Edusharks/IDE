...
export class DashboardBuilder {
    constructor(ideInstance) {
        ...
        this.defaultTemplates = {
            "Weather Station": [
                {"id":"heading_1","type":"heading","x":280,"y":20,"width":300,"height":50,"rotation":0,"scaleX":1,"label":"My Weather Station","color":"#1c2a3a","fontSize":24,"fontWeight":700,"textAlign":"center"},
                {"id":"card_1","type":"card","x":40,"y":100,"width":220,"height":120,"rotation":0,"scaleX":1,"value":"24.5°C","label":"Temperature","icon":"🌡️","color":"#f56565","bgColor":"#ffffff","fontSize":32,"fontWeight":700,"borderRadius":8},
                {"id":"card_2","type":"card","x":300,"y":100,"width":220,"height":120,"rotation":0,"scaleX":1,"value":"45%","label":"Humidity","icon":"💧","color":"#5a67d8","bgColor":"#ffffff","fontSize":32,"fontWeight":700,"borderRadius":8},
                {"id":"led_1","type":"led","x":560,"y":100,"width":80,"height":80,"rotation":0,"scaleX":1,"value":1,"min":0,"max":1,"label":"Status","colorOn":"#28a745","colorOff":"#555555"}
            ],
            "Robot Controller": [
                {"id":"joy_1","type":"joystick","x":40,"y":40,"width":200,"height":200,"rotation":0,"scaleX":1,"label":"Movement","radius":80,"valueX":0,"valueY":0},
                {"id":"btn_1","type":"button","x":300,"y":60,"width":120,"height":40,"rotation":0,"scaleX":1,"label":"Horn","value":"1","shape":"rounded","color":"#ffffff","bgColor":"#ed64a6","fontSize":16,"fontWeight":700,"borderRadius":20},
                {"id":"tog_1","type":"toggle","x":300,"y":140,"width":80,"height":50,"rotation":0,"scaleX":1,"label":"Lights","value":1,"min":0,"max":1,"color":"#f6ad55"}
            ]
        };
        ...
        this.dashboardComponentConfig = {
          'button':   { props: ['general', 'text', 'appearance', 'layout', 'data', 'transform', 'actions'], defaults: { width: 120, height: 40, rotation: 0, scaleX: 1, label: 'Button', value: '1', shape: 'rounded', color: '#ffffff', bgColor: '#007aff', fontSize: 16, fontWeight: 700, borderRadius: 20 } },
          'slider':   { props: ['general', 'text', 'appearance', 'layout', 'data', 'transform', 'actions'], defaults: { width: 200, height: 50, rotation: 0, scaleX: 1, label: 'Slider', value: 50, min: 0, max: 100, color: '#007aff', bgColor: '#ffffff', borderRadius: 8 } },
          'toggle':   { props: ['general', 'text', 'appearance', 'layout', 'data', 'transform', 'actions'], defaults: { width: 80, height: 50, rotation: 0, scaleX: 1, label: 'Toggle', value: 1, min: 0, max: 1, color: '#34c759' } },
          'color-picker': { props: ['general', 'text', 'layout', 'data', 'transform', 'actions'], defaults: { width: 150, height: 120, rotation: 0, scaleX: 1, label: 'Color Picker', value: '#007aff' } },
          'joystick': { props: ['general', 'text', 'layout', 'data', 'transform', 'actions'], defaults: { width: 150, height: 150, rotation: 0, scaleX: 1, label: 'Joystick', radius: 60, valueX: 0, valueY: 0 } },
          'gauge':    { props: ['general', 'text', 'appearance', 'layout', 'data', 'transform', 'actions'], defaults: { width: 180, height: 150, rotation: 0, scaleX: 1, value: 65, min: 0, max: 100, label: 'Gauge', color: '#007aff', fontSize: 14 } },
          'line-chart': { props: ['general', 'text', 'appearance', 'layout', 'data', 'transform', 'actions'], defaults: { width: 300, height: 200, rotation: 0, scaleX: 1, value: '30,50,45,65,70', options: 'Mon,Tue,Wed,Thu,Fri', label: 'History', color: '#007aff', bgColor: '#ffffff', borderRadius: 8 } },
          'led':      { props: ['general', 'text', 'appearance', 'layout', 'data', 'transform', 'actions'], defaults: { width: 80, height: 80, rotation: 0, scaleX: 1, value: 1, min: 0, max: 1, label: 'LED', colorOn: '#28a745', colorOff: '#555555' } },
          'card':     { props: ['general', 'text', 'appearance', 'layout', 'data', 'transform', 'actions'], defaults: { width: 220, height: 120, rotation: 0, scaleX: 1, value: 'Online', label: 'Device Status', icon: '✅', color: '#1c2a3a', bgColor: '#ffffff', fontSize: 32, fontWeight: 700, borderRadius: 8 } },
          'label':    { props: ['general', 'text', 'appearance', 'layout', 'transform', 'actions'], defaults: { width: 250, height: 50, rotation: 0, scaleX: 1, label: 'My Label', color: '#1c2a3a', fontSize: 18, fontWeight: 400, textAlign: 'left' } },
          'container':{ props: ['general', 'appearance', 'layout', 'transform', 'actions'], defaults: { width: 200, height: 150, rotation: 0, scaleX: 1, bgColor: '#ffffff', borderColor: '#e5e7eb', borderRadius: 8 } },
          'heading':  { props: ['general', 'text', 'appearance', 'layout', 'transform', 'actions'], defaults: { width: 250, height: 50, rotation: 0, scaleX: 1, label: 'My Dashboard', color: '#1c2a3a', fontSize: 24, fontWeight: 700, textAlign: 'left' } },
          'paragraph':{ props: ['general', 'text', 'appearance', 'layout', 'transform', 'actions'], defaults: { width: 250, height: 100, rotation: 0, scaleX: 1, label: 'This is a description of the dashboard.', color: '#6b7280', fontSize: 14, fontWeight: 400, textAlign: 'left' } },
          'image':    { props: ['general', 'appearance', 'layout', 'data', 'transform', 'actions'], defaults: { width: 150, height: 150, rotation: 0, scaleX: 1, src: 'https://via.placeholder.com/150', borderRadius: 8 } }
        };
    }
    ...
    init() {
        ...
        this.ui = {
            ...
            propRotateLeftBtn: document.getElementById('prop-rotate-left'),
            propRotateRightBtn: document.getElementById('prop-rotate-right'),
            propFlipHBtn: document.getElementById('prop-flip-h'),
        };
        ...
        this.ui.propRotateLeftBtn.addEventListener('click', () => this.rotateSelectedComponent(-90));
        this.ui.propRotateRightBtn.addEventListener('click', () => this.rotateSelectedComponent(90));
        this.ui.propFlipHBtn.addEventListener('click', () => this.flipSelectedComponent());
    ...
    renderDashboardComponent(comp) {
        ...
        el.style.cssText = `
            ...
            transform: rotate(${comp.rotation || 0}deg) scaleX(${comp.scaleX || 1});
    ...
    getComponentHTML(comp) {
        ...
        switch(comp.type) {
            ...
            case 'gauge': const circumference = Math.PI * 40; const progress = (parseFloat(value) - min) / (max - min); const offset = circumference * (1 - (progress * 0.5)); inner += `<div class="gauge-container"><svg viewBox="0 0 100 55" class="gauge-svg"><path d="M 10 50 A 40 40 0 0 1 90 50" fill="none" stroke-width="10" class="gauge-track" style="stroke: #e9ecef;" /><path id="${comp.id}" class="gauge-value" data-min="${comp.min}" data-max="${comp.max}" d="M 10 50 A 40 40 0 0 1 90 50" fill="none" stroke="${color}" stroke-width="10" style="stroke-dasharray:${circumference}; stroke-dashoffset:${offset};" /></svg><div class="gauge-text-container"><div id="val-${comp.id}" style="font-weight:bold;font-size: ${fontSize*1.2}px;">${value}</div><div class="label" style="font-size: ${fontSize}px;">${label}</div></div></div>`; break;
    ...
    updateDashboardPropertiesPanel(comp) {
        ...
        const componentVisibleProps = {
            'button':       ['id', 'label', 'value', 'shape', 'color', 'bgColor', 'fontSize', 'fontWeight', 'borderRadius', 'transform'],
            'slider':       ['id', 'label', 'value', 'min', 'max', 'color', 'fontSize', 'transform'],
            'toggle':       ['id', 'label', 'value', 'min', 'max', 'color', 'transform'],
            'color-picker': ['id', 'label', 'value', 'transform'],
            'joystick':     ['id', 'label', 'radius', 'valueX', 'valueY', 'transform'], 
            'gauge':        ['id', 'label', 'value', 'min', 'max', 'color', 'fontSize', 'transform'],
            'led':          ['id', 'label', 'value', 'min', 'max', 'colorOn', 'colorOff', 'transform'],
            'line-chart':   ['id', 'label', 'value', 'options', 'color', 'bgColor', 'borderRadius', 'transform'],
            'card':         ['id', 'label', 'value', 'icon', 'color', 'bgColor', 'fontSize', 'fontWeight', 'borderRadius', 'transform'],
            'label':        ['id', 'label', 'color', 'fontSize', 'fontWeight', 'textAlign', 'transform'],
            'container':    ['id', 'bgColor', 'borderColor', 'borderRadius', 'transform'],
            'heading':      ['id', 'label', 'color', 'fontSize', 'fontWeight', 'textAlign', 'transform'],
            'paragraph':    ['id', 'label', 'color', 'fontSize', 'fontWeight', 'textAlign', 'transform'],
            'image':        ['id', 'src', 'borderRadius', 'transform']
        };
    ...
    generateDashboardHTML() {
        ...
        this.dashboardComponents.forEach(comp => {
            const style = `position:absolute; left:${comp.x}px; top:${comp.y}px; width:${comp.width}px; height:${comp.height}px; background-color:${comp.bgColor || 'transparent'}; border-radius:${comp.borderRadius || 0}px; border: 1px solid ${comp.borderColor || 'transparent'}; display:flex; flex-direction:column; align-items:center; justify-content:center; box-sizing:border-box; padding:10px; transform: rotate(${comp.rotation || 0}deg) scaleX(${comp.scaleX || 1});`;
