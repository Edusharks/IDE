...
export function registerEsp32Blocks() {
    ...
    // Helper Block: A simple slider block to be used as a Shadow
    // This allows the PWM block to have a default slider that can be replaced
    const sliderHelperBlock = {
    ...
    // Register helper block first, then main blocks
    Blockly.defineBlocksWithJsonArray([sliderHelperBlock, ...blocks]);
}