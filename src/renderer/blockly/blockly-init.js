...
const Esp32IdeTheme = Blockly.Theme.defineTheme('esp32-ide-final', {
    ...
    'blockStyles': {
        // Core Blocks
        'loops_blocks': { 'colourPrimary': '#10B981' },     
...
class BlocklyWorkspace {
    ...
    rebuildAndApplyToolbox(loadedExtensionsSet) {
        // 1. Start with a fresh toolbox definition
        let freshToolbox = createBasicToolbox();

        // 2. Add board-specific categories
        if (this.boardId === 'esp32') {
        ...
        // 3. Add all currently loaded extensions
        ...
        // 4. Add the final separator and button
        ...
        // 5. Apply the newly constructed toolbox to the workspace
